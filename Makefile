Client : Client.o socket.o Blockable.o Grid.o Player.o BufferToggle.o
	g++ -o Client Client.o socket.o Blockable.o Grid.o Player.o BufferToggle.o -pthread -l rt
...
BufferToggle.o : BufferToggle.cpp
	g++ -c BufferToggle.cpp
